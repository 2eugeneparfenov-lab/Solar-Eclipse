...
public class Level19Controller {
    ...
    public Level19Controller() {
        newGame();
    }

    @RequestMapping("/lightsoff/level19/new")
    public String newGame() {
        copyBoard(level13);
        return "redirect:/lightsoff/level19";
    }

    @GetMapping("/lightsoff/level19")
    ...
    @GetMapping("/lightsoff/level19/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level19")
    @ResponseBody
