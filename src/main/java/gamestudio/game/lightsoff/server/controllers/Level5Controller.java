...
public class Level5Controller {
    ...
    @RequestMapping("/lightsoff/level5/new")
    public String newGame() {
        copyBoard(level5);
        return "redirect:/lightsoff/level5";
    }

    @GetMapping("/lightsoff/level5")
    ...
    @GetMapping("/lightsoff/level5/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level5")
    @ResponseBody
