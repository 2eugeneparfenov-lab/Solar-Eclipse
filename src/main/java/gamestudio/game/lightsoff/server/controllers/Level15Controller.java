...
public class Level15Controller {
    ...
    public Level15Controller() {
        newGame();
    }

    @RequestMapping("/lightsoff/level15/new")
    public String newGame() {
        copyBoard(level13);
        return "redirect:/lightsoff/level15";
    }

    @GetMapping("/lightsoff/level15")
    ...
    @GetMapping("/lightsoff/level15/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level15")
    @ResponseBody
