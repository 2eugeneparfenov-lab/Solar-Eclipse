...
public class Level12Controller {
    ...
    public Level12Controller() {
        newGame();
    }

    @RequestMapping("/lightsoff/level12/new")
    public String newGame() {
        copyBoard(level9);
        return "redirect:/lightsoff/level12";
    }

    @GetMapping("/lightsoff/level12")
    ...
    @GetMapping("/lightsoff/level12/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level12")
    @ResponseBody
