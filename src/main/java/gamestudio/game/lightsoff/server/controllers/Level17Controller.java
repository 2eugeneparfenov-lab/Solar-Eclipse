...
public class Level17Controller {
    ...
    public Level17Controller() {
        newGame();
    }

    @RequestMapping("/lightsoff/level17/new")
    public String newGame() {
        copyBoard(level13);
        return "redirect:/lightsoff/level17";
    }

    @GetMapping("/lightsoff/level17")
    ...
    @GetMapping("/lightsoff/level17/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level17")
    @ResponseBody
