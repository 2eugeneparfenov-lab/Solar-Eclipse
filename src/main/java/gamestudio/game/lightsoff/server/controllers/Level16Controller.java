...
public class Level16Controller {
    ...
    public Level16Controller() {
        newGame();
    }

    @RequestMapping("/lightsoff/level16/new")
    public String newGame() {
        copyBoard(level13);
        return "redirect:/lightsoff/level16";
    }

    @GetMapping("/lightsoff/level16")
    ...
    @GetMapping("/lightsoff/level16/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level16")
    @ResponseBody
