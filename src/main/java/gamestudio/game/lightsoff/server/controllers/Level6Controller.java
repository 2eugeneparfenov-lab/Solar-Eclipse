...
public class Level6Controller {
    ...
    @RequestMapping("/lightsoff/level6/new")
    public String newGame() {
        copyBoard(level5);
        return "redirect:/lightsoff/level6";
    }

    @GetMapping("/lightsoff/level6")
    ...
    @GetMapping("/lightsoff/level6/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level6")
    @ResponseBody
