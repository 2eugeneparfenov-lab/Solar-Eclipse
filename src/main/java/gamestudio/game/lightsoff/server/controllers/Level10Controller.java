...
public class Level10Controller {
    ...
    @RequestMapping("/lightsoff/level10/new")
    public String newGame() {
        copyBoard(level10);
        return "redirect:/lightsoff/level10";
    }

    @GetMapping("/lightsoff/level10")
    ...
    @GetMapping("/lightsoff/level10/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level10")
    @ResponseBody
