...
public class Level13Controller {
    ...
    public Level13Controller() {
        newGame();
    }

    @RequestMapping("/lightsoff/level13/new")
    public String newGame() {
        copyBoard(level13);
        return "redirect:/lightsoff/level13";
    }

    @GetMapping("/lightsoff/level13")
    ...
    @GetMapping("/lightsoff/level13/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level13")
    @ResponseBody
