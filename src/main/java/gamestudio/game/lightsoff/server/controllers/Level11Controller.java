...
public class Level11Controller {
    ...
    public Level11Controller() {
        newGame();
    }

    @RequestMapping("/lightsoff/level11/new")
    public String newGame() {
        copyBoard(level11);
        return "redirect:/lightsoff/level11";
    }

    @GetMapping("/lightsoff/level11")
    ...
    @GetMapping("/lightsoff/level11/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level11")
    @ResponseBody
