...
public class Level3Controller {
    ...
    @RequestMapping("/lightsoff/level3/new")
    public String newGame() {
        copyBoard(level3);
        return "redirect:/lightsoff/level3";
    }

    @GetMapping("/lightsoff/level3")
    public String level2(
        ...
        return "level3"; // 👈 тут важливо!
    }

    @GetMapping("/lightsoff/level3/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level3")
    @ResponseBody
