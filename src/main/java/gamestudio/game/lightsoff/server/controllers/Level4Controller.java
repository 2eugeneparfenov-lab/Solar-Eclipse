...
public class Level4Controller {
    ...
    @RequestMapping("/lightsoff/level4/new")
    public String newGame() {
        copyBoard(level4);
        return "redirect:/lightsoff/level4";
    }

    @GetMapping("/lightsoff/level4")
    public String level4(
        ...
        return "level4"; // 👈 тут важливо!
    }

    @GetMapping("/lightsoff/level4/state")
    @ResponseBody
    public String getHtmlState() {
        return getHtmlField();
    }

    @GetMapping("/api/gameState/level4")
    @ResponseBody
